            ...
            <div class="card-box">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" value="{{$settings['contact_seo_title_ar']}}"
                               name="contact_seo_title_ar"
                               class="form-control">
                    </div>

                    <div class="form-group col-md-6">
                        <label>{{trans('settings.page_seo_title_en')}}</label>
                        <input type="text" value="{{$settings['contact_seo_title_en']}}"
                               name="contact_seo_title_en"
                               class="form-control">
                    </div>

                    <div class="form-group col-md-12">
                        <label>{{trans('settings.meta_keywords_ar_with_comma_separated')}}</label>
                        <input type="text" value="{{$settings['contact_seo_keywords_ar']}}"
                               name="contact_seo_keywords_ar"
                               class="form-control">
                    </div>

                    <div class="form-group col-md-12">
                        <label>{{trans('settings.meta_keywords_en_with_comma_separated')}}</label>
                        <input type="text" value="{{$settings['contact_seo_keywords_en']}}"
                               name="contact_seo_keywords_en"
                               class="form-control">
                    </div>

                    <div class="form-group col-md-12">
                        <label>{{trans('settings.meta_description_ar')}}</label>
                        <input type="text" value="{{$settings['contact_seo_desc_ar']}}"
                               name="contact_seo_desc_ar"
                               class="form-control">
                    </div>

                    <div class="form-group col-md-12">
                        <label>{{trans('settings.meta_description_en')}}</label>
                        <input type="text" value="{{$settings['contact_seo_desc_en']}}"
                               name="contact_seo_desc_en"
                               class="form-control">
                    </div>
                    <div class="form-group col-md-12">
